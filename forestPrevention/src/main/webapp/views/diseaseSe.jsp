...
<body>
    ...
    <div class="layui-card-body">
        <div class="layui-btn-container">
            <button class="layui-btn layui-btn-primary layui-btn-sm" style=" position:relative;left:50px">添加新病害</button>
    ...
    <div style="border: solid #b2b2b2;width: 400px;height: 200px;position:relative;left:500px;top: -80px">
        <span style=" position:absolute;top:-30px;left:30px">查询病害信息</span>
        <span style=" position:absolute;top:40px;left:30px">病害名称</span>
        <input type="text" style=" position:absolute;top:40px;left:140px"/>
        <span style=" position:absolute;top:90px;left:30px">发病症状</span>
