...
<div class="layui-card-body">
    ...
    <span style=" position:relative;left:50px;top: 15px">繁殖</span>
    ...
    <span style=" position:relative;left:50px;top: 20px">食物</span>
    <p style="width: 250px;word-wrap:break-word;word-break:break-all;overflow: hidden;position:relative;left:150px;top:-25px;">${insectPestBreed}</p><br>
    <span style=" position:relative;left:50px;top: 25px">天敌</span>
    <p style="width: 250px;word-wrap:break-word;word-break:break-all;overflow: hidden;position:relative;left:150px;top:-25px;">${insectPestBreed}</p><br>
    <span style=" position:relative;left:550px;top: 30px">主要危害</span>
    <p style="width: 250px;word-wrap:break-word;word-break:break-all;overflow: hidden;position:relative;left:150px;top:-25px;">${insectPestBreed}</p><br>
