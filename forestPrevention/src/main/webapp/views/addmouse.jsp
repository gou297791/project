...
<div class="layui-card-body">
    ...
    <input type="text" name="mouName" style=" position:relative;left:120px"/>
    <span style=" position:relative;left:280px">食物</span>
    <input type="text" name="mouFood" style=" position:relative;left:350px"/>
    <br>
    <span style=" position:relative;left:50px;top: 50px">繁殖</span>
    <input type="text" name="mouBreed" style=" position:relative;left:120px;top: 50px"/>
    <span style=" position:relative;left:280px;top: 50px">天敌</span>
    <input type="text" name="mouEnemy" style=" position:relative;left:350px;top: 50px"/>
    <br>
    ...
    <textarea rows="5" name="mouMethod" cols="23"style=" position:relative;left:90px;top: 150px"></textarea>
    <span style=" position:relative;left:250px;top: 80px">主要危害</span>
    <textarea rows="5" name="mouHarm" cols="23"style=" position:relative;left:295px;top: 150px"></textarea>
    <br>
</div>
...
<form action="upload.lovo" method="post" enctype="multipart/form-data">
    ...
    <table>
        ...
        <input type="text" name="" style=" position:relative;left:90px;top: 100px"/>
    </table>
